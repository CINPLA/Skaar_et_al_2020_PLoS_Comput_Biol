...
if __name__ == '__main__':
    ...
    PSET['sigma_factor'] = ps.ParameterRange([0.01, 0.02, 0.05, 0.1, 0.2, 0.5, 1.0, 1.5, 2.0])
    PSET['simtime'] = 3000.
    ...
    PSET['theta_gaussian'] = True

    # set up directory structure
    savefolder = os.path.join('./lfp_simulations_gaussian_theta/')
